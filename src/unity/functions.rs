...
impl Il2CppFunctions {
  pub fn new(base: usize) -> Self {
    Il2CppFunctions {
      il2cpp_domain_get: get_method_ptr(base + 0x1df0820),
      il2cpp_domain_get_assemblies: get_method_ptr(base + 0x1df0830),
      il2cpp_assembly_get_image: get_method_ptr(base + 0x1df06d8),
      il2cpp_image_get_class_count: get_method_ptr(base + 0x1df0b68),
      il2cpp_image_get_class: get_method_ptr(base + 0x1df0b70),
      il2cpp_class_get_methods: get_method_ptr(base + 0x1df0740),
      il2cpp_class_get_name: get_method_ptr(base + 0x1df0750),
      il2cpp_class_get_namespace: get_method_ptr(base + 0x1df0760),
      il2cpp_method_get_name: get_method_ptr(base + 0x1df09c8)
    }
  }
}